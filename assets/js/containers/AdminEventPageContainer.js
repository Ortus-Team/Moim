...
import { EventContent } from '../components/adminevent/EventContent';
import { UpcomingEvents } from '../components/UpcomingEvents';
import { EditEvent } from '../components/adminevent/EditEvent';
import { Link } from 'react-router';
import { EditEventLink } from '../components/adminevent/EditEventLink';

export class AdminEventPageContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      styleEventEdit: {
  ...
  editOn() {
    const styleEventEdit = { display: 'block' };
    this.setState({ styleEventEdit });
  }

  editOff() {
    document.removeEventListener("click", this.editOff);
    const styleEventEdit = { display: 'none' };
    this.setState({ styleEventEdit });
  }
  ...
  render() {
    return (
      <div className="adminEventPageWrapper">
        <div className='displayEventEdit' style={this.state.styleEventEdit}>
          <EditEvent off={this.editOff} />
        </div>
        <Navbar />
        <div className="adminEventPageContent">
          <div className="adminEventPageWrapper">
              ...
              <div className="info">
                <div className="overview">
                  <div className='overviewMainAdmin'>
                    ...
                    <EditEventLink editOn={this.editOn} />
                  </div>
